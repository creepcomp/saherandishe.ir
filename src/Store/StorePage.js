...
const StorePage = (props) => {
    ...
    return (
        <Container className="my-2" fluid>
            <Row>
                <Col lg={3}>
                    <div className="bg-primary rounded text-light mb-1 p-2">
                        ...
                        <Button className="w-100" variant="light" onClick={update}>اعمال فیلتر</Button>
                    </div>
                </Col>
                <Col>
                    <div className="bg-primary rounded text-light mb-1 p-2">
                        <h1 className="text-center border-bottom">فروشگاه</h1>
