            ...
            <Modal.Body>
                <Container ref={printArea} dir="rtl">
                    <Row>
                        ...
                        <Col xs={4}>
                            <img className="border m-1 p-1" src={"https://api.qrserver.com/v1/create-qr-code/?size=125x125&data=" + `https://saherandishe.ir/store/product/${product.slug}/`} />
                        </Col>
                    </Row>
                    ...
                    <footer className="border-top text-center">
                        <a className="d-block" href="https://saherandishe.ir">
                            saherandishe.ir
                        </a>
